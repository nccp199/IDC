...
def final_metrics_from_info(total_reward: float, info: Dict[str, Any]) -> Dict[str, float]:
    ...
    return {
        ...
        "P_local_demand_kW": sf(info.get("P_local_demand_kW")),
        "P_local_net_before_pv_kW": sf(info.get("P_local_net_before_pv_kW")),
        "P_bus_net_kW": sf(info.get("P_bus_net_kW")),
        "pv_available_kW": sf(info.get("pv_available_kW")),
        "pv_used_kW": sf(info.get("pv_used_kW")),
        "pv_curtail_kW": sf(info.get("pv_curtail_kW")),
        "pv_available_kWh": sf(info.get("pv_available_kWh")),
        "pv_used_kWh": sf(info.get("pv_used_kWh")),
        "pv_curtail_kWh": sf(info.get("pv_curtail_kWh")),
        "total_pv_available_kWh": sf(info.get("total_pv_available_kWh")),
        "total_pv_used_kWh": sf(info.get("total_pv_used_kWh")),
        "total_pv_curtail_kWh": sf(info.get("total_pv_curtail_kWh")),
        "pv_utilization_rate": sf(info.get("pv_utilization_rate")),
        "renewable_share": sf(info.get("renewable_share")),
...
def ordered_fieldnames(rows: List[Dict[str, Any]]) -> List[str]:
    preferred = [
        ...
        "P_local_demand_kW", "P_local_net_before_pv_kW", "P_bus_net_kW",
        "pv_available_kW", "pv_used_kW", "pv_curtail_kW",
        "total_pv_available_kWh", "total_pv_used_kWh", "total_pv_curtail_kWh",
        "pv_utilization_rate", "renewable_share",
